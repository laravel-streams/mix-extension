...
import { Compiler, ModuleDependency } from 'webpack';
import { AsyncSeriesBailHook, AsyncSeriesWaterfallHook, HookMap, SyncBailHook, SyncHook, SyncWaterfallHook } from 'tapable';
import ei from 'extendable-immutable'
...
declare module 'webpack' {
    ...
    import { AsArray, AsyncParallelHook, AsyncSeriesBailHook, AsyncSeriesHook, AsyncSeriesWaterfallHook, HookMap, MultiHook, SyncBailHook, SyncHook, SyncWaterfallHook } from 'tapable';
    ...
    export type BuildMeta = KnownBuildMeta & Record<string, any>;
    ...
    export type CacheOptionsNormalized = false | FileCacheOptions | MemoryCacheOptions;
    ...
    export interface CallbackAsyncQueue<T> {
    ...
    export type Cell<T> = undefined | T;
    ...
    export type ChunkGroupOptions = RawChunkGroupOptions & { name?: string };
    ...
    export interface ChunkRenderContext {
        /**
         * the chunk
         */
        chunk: Chunk;
    ...
    export interface CleanPluginCompilationHooks {
        /**
    ...
    export type CodeValue =
        ...
        | RuntimeValue
        | {
              [ index: string ]: RecursiveArrayOrRecord<| undefined
                                                        | null
                                                        | string
                                                        | number
                                                        | bigint
        ...
        | RecursiveArrayOrRecord<| undefined
                                 | null
                                 | string
                                 | number
                                 | bigint
                                 ...
                                 | RegExp
                                 | RuntimeValue>[];
    export type CodeValuePrimitive =
        | undefined
        | null
        | string
        | number
    ...
    export class Compilation {
        ...
        hooks: Readonly<{
            ...
            optimizeChunkModules: AsyncSeriesBailHook<[ Iterable<Chunk>, Iterable<Module> ],
                any>;
            ...
            additionalChunkAssets: FakeHook<Pick<AsyncSeriesHook<[ Set<Chunk> ]>,
                'name' | 'tap' | 'tapAsync' | 'tapPromise'>>;
            additionalAssets: FakeHook<Pick<AsyncSeriesHook<[]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>;
            optimizeChunkAssets: FakeHook<Pick<AsyncSeriesHook<[ Set<Chunk> ]>,
                'name' | 'tap' | 'tapAsync' | 'tapPromise'>>;
            afterOptimizeChunkAssets: FakeHook<Pick<AsyncSeriesHook<[ Set<Chunk> ]>,
                'name' | 'tap' | 'tapAsync' | 'tapPromise'>>;
        ...
        factorizeQueue: AsyncQueue<FactorizeModuleOptions,
            string,
    ...
    export interface CompilationHooksJavascriptModulesPlugin {
        ...
        inlineInRuntimeBailout: SyncBailHook<[ Module, RenderBootstrapContext ],
            string>;
    ...
    export interface CompilationHooksRealContentHashPlugin {
    ...
    export class ConstDependency extends NullDependency {
        constructor(
            expression: string,
    ...
    export class ConstDependencyTemplate extends NullDependencyTemplate {
        constructor();
    }
    ...
    export type Consumes = (string | ConsumesObject)[] | ConsumesObject;
    ...
    export interface ContextFileSystemInfoEntry {
        safeTime: number;
    ...
    export abstract class ContextModuleFactory extends ModuleFactory {
        hooks: Readonly<{
            ...
            alternatives: FakeHook<Pick<AsyncSeriesWaterfallHook<[ any[] ]>,
                'name' | 'tap' | 'tapAsync' | 'tapPromise'>>;
    ...
    export interface ContextTimestampAndHash {
        safeTime: number;
        timestampHash?: string;
        hash: string;
    ...
    export class DependencyTemplate {
        constructor();
    ...
    export type EntryOptions = { name?: string } & Omit<EntryDescriptionNormalized,
        'import'>;
    ...
    export type EntryStatic = string | EntryObject | string[];
    ...
    export interface ExecuteModuleResult {
        exports: any;
        cacheable: boolean;
        assets: Map<string, { source: Source; info: AssetInfo }>;
        fileDependencies: LazySet<string>;
    ...
    export type ExperimentsNormalized = ExperimentsCommon & ExperimentsNormalizedExtra;
    ...
    export type ExportedVariableInfo = string | ScopeInfo | VariableInfo;
    ...
    export interface ExpressionExpressionInfo {
        type: 'expression';
        rootInfo: string | VariableInfo;
        name: string;
        getMembers: () => string[];
    ...
    export type ExternalItemValue = string | boolean | string[] | { [ index: string ]: any };
    ...
    export abstract class FileSystemInfo {
        ...
        contextTimestampQueue: AsyncQueue<string,
            string,
    ...
    export abstract class InitFragment<Context> {
    ...
    export type InternalCell<T> = T | typeof TOMBSTONE | typeof UNDEFINED_MARKER;
    ...
    export class JavascriptParser extends Parser {
        ...
        hooks: Readonly<{
            evaluateTypeof: HookMap<SyncBailHook<[ UnaryExpression ],
                undefined | null | BasicEvaluatedExpression>>;
            evaluate: HookMap<SyncBailHook<[ Expression ], undefined | null | BasicEvaluatedExpression>>;
            evaluateIdentifier: HookMap<SyncBailHook<[ ThisExpression | MemberExpression | MetaProperty | Identifier ],
                undefined | null | BasicEvaluatedExpression>>;
            evaluateDefinedIdentifier: HookMap<SyncBailHook<[ ThisExpression | MemberExpression | Identifier ],
                undefined | null | BasicEvaluatedExpression>>;
            evaluateCallExpressionMember: HookMap<SyncBailHook<[ CallExpression, undefined | BasicEvaluatedExpression ],
                undefined | null | BasicEvaluatedExpression>>;
            isPure: HookMap<SyncBailHook<[
                (
                    | UnaryExpression
                    | ThisExpression
                    | ArrayExpression
            ...
            classExtendsExpression: SyncBailHook<[ Expression, ClassExpression | ClassDeclaration ],
                boolean | void>;
            ...
            importSpecifier: SyncBailHook<[ ImportDeclaration, ImportSource, string, string ],
                boolean | void>;
            export: SyncBailHook<[ ExportNamedDeclaration | ExportAllDeclaration ],
                boolean | void>;
            exportImport: SyncBailHook<[ ExportNamedDeclaration | ExportAllDeclaration, ImportSource ],
                boolean | void>;
            exportDeclaration: SyncBailHook<[ ExportNamedDeclaration | ExportAllDeclaration, Declaration ],
                boolean | void>;
            exportExpression: SyncBailHook<[ ExportDefaultDeclaration, Declaration ],
                boolean | void>;
            ...
            exportImportSpecifier: SyncBailHook<[
                ...
                boolean | void>;
            preDeclarator: SyncBailHook<[ VariableDeclarator, Statement ],
                boolean | void>;
            ...
            memberChainOfCallMemberChain: HookMap<SyncBailHook<[ Expression, string[], CallExpression, string[] ],
                boolean | void>>;
            callMemberChainOfCallMemberChain: HookMap<SyncBailHook<[ Expression, string[], CallExpression, string[] ],
                boolean | void>>;
    ...
    export interface KnownStatsAsset {
        type: string;
        name: string;
        info: AssetInfo;
        size: number;
    ...
    export interface KnownStatsChunk {
        rendered: boolean;
        initial: boolean;
        entry: boolean;
        recorded: boolean;
    ...
    export interface KnownStatsChunkGroup {
        name?: string;
        chunks?: (string | number)[];
    ...
    export interface KnownStatsChunkOrigin {
        module?: string;
    ...
    export interface KnownStatsCompilation {
        env?: any;
        name?: string;
        hash?: string;
        version?: string;
    ...
    export interface KnownStatsError {
        message: string;
        chunkName?: string;
        chunkEntry?: boolean;
    ...
    export interface KnownStatsFactoryContext {
        type: string;
    ...
    export interface KnownStatsLogging {
        entries: StatsLoggingEntry[];
        filteredEntries: number;
        debug: boolean;
    }

    export interface KnownStatsLoggingEntry {
        type: string;
        message: string;
        trace?: string[];
    ...
    export interface KnownStatsModule {
        type?: string;
        moduleType?: string;
        layer?: string;
        identifier?: string;
    ...
    export interface KnownStatsModuleIssuer {
        identifier?: string;
        name?: string;
        id?: string | number;
        profile?: StatsProfile;
    ...
    export interface KnownStatsModuleReason {
        moduleIdentifier?: string;
        module?: string;
        moduleName?: string;
    ...
    export interface KnownStatsModuleTraceDependency {
        loc?: string;
    }

    export interface KnownStatsModuleTraceItem {
    ...
    export interface KnownStatsPrinterContext {
        type?: string;
    ...
    export interface KnownStatsProfile {
        total: number;
        resolving: number;
        restoring: number;
        building: number;
    ...
    export type LoaderContext<OptionsType> = NormalModuleLoaderContext<OptionsType> &
                                             LoaderRunnerLoaderContext<OptionsType> &
                                             LoaderPluginLoaderContext &
                                             HotModuleReplacementPluginLoaderContext;
    export type LoaderDefinition<OptionsType = {},
        ContextAdditions = {}> = LoaderDefinitionFunction<OptionsType, ContextAdditions> & {
        raw?: false;
        pitch?: PitchLoaderDefinitionFunction<OptionsType, ContextAdditions>;
    };

    export interface LoaderDefinitionFunction<OptionsType = {},
        ContextAdditions = {}> {
        (
    ...
    export type ModuleInfo = ConcatenatedModuleInfo | ExternalModuleInfo;
    ...
    export type NodeWebpackOptions = false | NodeOptions;
    ...
    export interface NormalModuleCreateData {
        /**
    ...
    export class NullDependency extends Dependency {
        constructor();
    ...
    export class NullDependencyTemplate extends DependencyTemplate {
        constructor();
    }
    ...
    export interface ParameterizedComparator<TArg, T> {
    ...
    export interface PitchLoaderDefinitionFunction<OptionsType = {},
        ContextAdditions = {}> {
        (
            this: NormalModuleLoaderContext<OptionsType> &
                  LoaderRunnerLoaderContext<OptionsType> &
    ...
    export interface ProcessAssetsAdditionalOptions {
    ...
    export type Provides = (string | ProvidesObject)[] | ProvidesObject;
    ...
    export type RawLoaderDefinition<OptionsType = {},
        ContextAdditions = {}> = RawLoaderDefinitionFunction<OptionsType, ContextAdditions> & {
        raw: true;
        pitch?: PitchLoaderDefinitionFunction<OptionsType, ContextAdditions>;
    };

    export interface RawLoaderDefinitionFunction<OptionsType = {},
        ContextAdditions = {}> {
        (
            this: NormalModuleLoaderContext<OptionsType> &
                  LoaderRunnerLoaderContext<OptionsType> &
    ...
    export class RealContentHashPlugin {
    ...
    export type RecursiveArrayOrRecord<T> =
    ...
    export type ResolveOptionsWithDependencyType = ResolveOptionsWebpackOptions & {
        dependencyType?: string;
        resolveToContext?: boolean;
    };
    ...
    export interface ResolvedContextFileSystemInfoEntry {
        safeTime: number;
        timestampHash?: string;
    }

    export interface ResolvedContextTimestampAndHash {
        safeTime: number;
        timestampHash?: string;
        hash: string;
    }
    ...
    export interface ResourceDataWithData {
        resource: string;
        path: string;
        query: string;
        fragment: string;
    ...
    export type RuleSetConditionOrConditions =
        | string
        | RegExp
        | ((value: string) => boolean)
        | RuleSetLogicalConditions
    ...
    export type RuntimeCondition = undefined | string | boolean | SortableSet<string>;
    ...
    export interface RuntimeRequirementsContext {
        /**
         * the chunk graph
         */
        chunkGraph: ChunkGraph;
    ...
    export type RuntimeSpec = undefined | string | SortableSet<string>;
    ...
    export type ServerOptionsHttps = SecureContextOptions &
                                     TlsOptions &
                                     ServerOptionsImport;
    ...
    export interface SplitChunksSizes {
        [ index: string ]: number;
    }
    ...
    export type StartupRenderContext = RenderContext & { inlined: boolean };
    ...
    export abstract class StatsFactory {
        hooks: Readonly<{
            ...
            sort: HookMap<SyncBailHook<[ ((arg0?: any, arg1?: any) => number)[], StatsFactoryContext ],
                any>>;
            ...
            sortResults: HookMap<SyncBailHook<[ ((arg0?: any, arg1?: any) => number)[], StatsFactoryContext ],
                any>>;
    ...
    export type StatsModuleTraceDependency = KnownStatsModuleTraceDependency &
                                             Record<string, any>;
    export type StatsModuleTraceItem = KnownStatsModuleTraceItem & Record<string, any>;
    ...
    export class SyncModuleIdsPlugin {
        constructor(__0: {
            /**
             * path to file
             */
    ...
    export const TRANSITIVE: unique symbol;
    ...
    export type UsageStateType = 0 | 1 | 2 | 3 | 4;
    ...
    export interface VariableInfoInterface {
        exportdScope: ScopeInfo;
        freeName: string | true;
        tagInfo?: TagInfo;
    }
    ...
    export abstract class WeakTupleMap<T extends any[], V> {
        set(...args: [ T, ...V[] ]): void;
    ...
    export interface WebAssemblyRenderContext {
        /**
         * the chunk
         */
        chunk: Chunk;
    ...
    export type __TypeWebpackOptions = (data: object) =>
        | string
        | {
              /**
               * Unique loader options identifier.
    ...
    export namespace util {
        ...
        export namespace comparators {
            ...
            export let compareModulesById: ParameterizedComparator<ChunkGraph,
                Module>;
            export let compareNumbers: (a: number, b: number) => 0 | 1 | - 1;
            export let compareStringsNumeric: (a: string, b: string) => 0 | 1 | - 1;
            export let compareModulesByPostOrderIndexOrIdentifier: ParameterizedComparator<ModuleGraph,
                Module>;
            export let compareModulesByPreOrderIndexOrIdentifier: ParameterizedComparator<ModuleGraph,
                Module>;
            export let compareModulesByIdOrIdentifier: ParameterizedComparator<ChunkGraph,
                Module>;
